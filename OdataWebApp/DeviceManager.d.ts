...
declare module DeviceManagerService {
  export class Connection extends $data.Entity {
    constructor();
    constructor(initData: { ID?: number; ConnectionTypeID?: number; BaudRate?: number; DataBits?: number; StopBits?: number; Parity?: string; RTSCTS?: bool; DTR?: bool; RTS?: bool; XonXoff?: bool; PhoneNumber?: string; ATString?: string; IPAddress?: string; PortNumber?: number; Devices?: DeviceManagerService.Device[]; ConnectionType?: DeviceManagerService.ConnectionType; });
    ID: number;
  ...
  export class Device extends $data.Entity {
    constructor();
    constructor(initData: { ID?: number; Name?: string; DeviceTypeID?: number; ConnectionID?: number; Description?: string; SerialNumber?: string; FirmwareRevision?: string; PartNumber?: string; FIDString?: string; GlobalDeviceID?: string; Nodes?: DeviceManagerService.Node[]; DeviceDocuments?: DeviceManagerService.DeviceDocument[]; Connection?: DeviceManagerService.Connection; DeviceType?: DeviceManagerService.DeviceType; });
    ID: number;
    Name: string;
    DeviceTypeID: number;
    ConnectionID: number;
